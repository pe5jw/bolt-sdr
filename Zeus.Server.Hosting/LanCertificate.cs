...
{
    private const string CertFileName = "bolt-sdr-lan.pfx";
    ...
    private static X509Certificate2 Generate(HashSet<IPAddress> ips)
    {
        ...
        var req = new CertificateRequest(
            $"CN=Bolt SDR on {Environment.MachineName}",
            rsa,
    ...
    private static string ResolveCertPath()
    {
        ...
        return Path.Combine(dir, "BoltSDR", "certs", CertFileName);
    }
}
