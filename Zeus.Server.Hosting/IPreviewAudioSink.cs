...
/// controls to manage levels. Audio Suite preview itself is not published
...
/// browser mode binds <see cref="NoOpPreviewAudioSink"/> because this local
/// playback side-channel is only meaningful for native audio output.</para>
///
/// <para><see cref="PublishPreview"/> runs on the miniaudio capture
...
public interface IPreviewAudioSink
{
    ...
    /// </summary>
    void PublishPreview(ReadOnlySpan<float> monoSamples, int sampleRate);
}
