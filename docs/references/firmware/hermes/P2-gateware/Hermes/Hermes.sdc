...
#set_max_delay -from _122MHz -to PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3] 7
...
set_max_delay -from userADC_clk -to network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 11
...
set_false_path -from [get_clocks {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {tx_clock}]
