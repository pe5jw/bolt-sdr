...
# 18th Nov - Added DAC_clock_15 i.e. phase shifted DAC clock
...
create_generated_clock -name {clock_12_5_mhz_0_deg} -source {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|inclk[0]} -divide_by 10 -duty_cycle 50.00 {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[2]} -add
create_generated_clock -name {clock_25_mhz_180_deg} -source {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|inclk[0]} -divide_by 5 -phase 180.00 -duty_cycle 50.00 {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]} -add



# PHY Tx clock
create_generated_clock -name {PHY_TX_CLOCK} -source {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|inclk[0]} -duty_cycle 50.00 {network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]} -add


# tx_clock
#create_generated_clock -name tx_clock -source [clock_12_5_mhz_0_deg] 

# PHY rx_clock
#create_generated_clock -name rx_clock -source [network:network_inst|rgmii_recv:rgmii_recv_inst|rx_clock]  -master_clock [PHY_RX_CLOCK] -divide_by 2
#create_generated_clock -name rx_clock -source  PHY_RX_CLOCK -divide_by 2 rx_clock
create_generated_clock -name {rx_clock} -master_clock {PHY_RX_CLOCK} -source [get_pins {network_inst|rgmii_recv_inst|rx_clock|clk}] -divide_by 2 -duty_cycle 50 [get_pins {network_inst|rgmii_recv_inst|rx_clock|q}]


# data_clock = CMCLK/2 used by Attenuator and TLV320 SPI
create_generated_clock -name data_clk -source $CMCLK -divide_by 2 

# data_clk2 = CBCLK/4 
create_generated_clock -name data_clk2 -source $CBCLK -divide_by 4
...
#PHY Data in 
set_input_delay  0.8  -clock rx_clock {PHY_RX[*] RX_DV}  
...
#122.88MHz clock data
set_output_delay  1.000 -clock _122MHz   {DACD[*] FPGA_PLL DAC_ALC}

#PHY TX data
set_output_delay   1.0  -clock PHY_TX_CLOCK [get_ports {PHY_TX* PHY_TX_EN}]
...
#set_max_delay -from network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 20
...
#set_max_delay -from _122MHz -to PLL_inst|altpll_component|auto_generated|pll1|clk[1] 8

set_max_delay -from PHY_RX_CLOCK -to PHY_RX_CLOCK 10

#set_max_delay -from PLL_inst|altpll_component|auto_generated|pll1|clk[1] -to PLL_inst|altpll_component|auto_generated|pll1|clk[1] 11
...
set_false_path -fall_from [get_clocks network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]] -rise_to [get_clocks PHY_TX_CLOCK] -setup
set_false_path -rise_from [get_clocks network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]] -fall_to [get_clocks PHY_TX_CLOCK] -setup
set_false_path -fall_from [get_clocks network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]] -fall_to [get_clocks PHY_TX_CLOCK] -hold
set_false_path -rise_from [get_clocks network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3]] -rise_to [get_clocks PHY_TX_CLOCK] -hold
