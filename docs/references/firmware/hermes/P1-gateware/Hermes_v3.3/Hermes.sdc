...
set_max_delay -from LTC2208_122MHz -to PLL_inst|altpll_component|auto_generated|pll1|clk[1] 8

set_max_delay -from PLL_clocks_inst|altpll_component|auto_generated|pll1|clk[0] -to PHY_CLK125 12
...
set_max_delay -from PLL_IF_inst|altpll_component|auto_generated|pll1|clk[2] -to pro_count[2] 6
