...
//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" DATA_WIDTH="STANDARD" DEVICE_FAMILY="Cyclone IV E" EPCS_TYPE="EPCS128" PAGE_SIZE=256 PORT_BULK_ERASE="PORT_USED" PORT_EN4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_UNUSED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_UNUSED" PORT_READ_ADDRESS="PORT_UNUSED" PORT_READ_RDID="PORT_UNUSED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_UNUSED" PORT_SECTOR_ERASE="PORT_USED" PORT_SECTOR_PROTECT="PORT_USED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_EAB="ON" addr bulk_erase busy clkin data_valid datain dataout illegal_erase illegal_write rden read sector_erase sector_protect shift_bytes wren write INTENDED_DEVICE_FAMILY="Cyclone IV E" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
//VERSION_BEGIN 11.1SP2 cbx_a_gray2bin 2012:01:25:21:13:53:SJ cbx_a_graycounter 2012:01:25:21:13:53:SJ cbx_altasmi_parallel 2012:01:25:21:13:53:SJ cbx_altdpram 2012:01:25:21:13:53:SJ cbx_altsyncram 2012:01:25:21:13:53:SJ cbx_cyclone 2012:01:25:21:13:53:SJ cbx_cycloneii 2012:01:25:21:13:53:SJ cbx_fifo_common 2012:01:25:21:13:53:SJ cbx_lpm_add_sub 2012:01:25:21:13:53:SJ cbx_lpm_compare 2012:01:25:21:13:53:SJ cbx_lpm_counter 2012:01:25:21:13:53:SJ cbx_lpm_decode 2012:01:25:21:13:53:SJ cbx_lpm_mux 2012:01:25:21:13:53:SJ cbx_mgl 2012:01:25:21:15:41:SJ cbx_scfifo 2012:01:25:21:13:53:SJ cbx_stratix 2012:01:25:21:13:53:SJ cbx_stratixii 2012:01:25:21:13:53:SJ cbx_stratixiii 2012:01:25:21:13:53:SJ cbx_stratixv 2012:01:25:21:13:53:SJ cbx_util_mgl 2012:01:25:21:13:53:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463


//synthesis_resources = a_graycounter 5 cycloneii_asmiblock 1 lpm_compare 2 lpm_counter 2 lut 70 mux21 1 reg 123 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  ASMI_altasmi_parallel_efc2
	( 
	addr,
	bulk_erase,
	busy,
...
`endif
	...
	( 
	.aclr(clr_write_wire),
	.clk_en(((((((do_write | do_sec_erase) | do_bulk_erase) & (~ write_prot_true)) | do_4baddr) & end_wrstage) & (~ st_busy_wire))),
	.clock((~ clkin_wire)),
	...
	// synopsys translate_on
	always @ ( negedge clkin_wire)
		  clr_write_reg <= (((((((((((((do_write | do_sec_erase) | do_bulk_erase) | do_4baddr) & wire_wrstage_cntr_q[1]) & (~ wire_wrstage_cntr_q[0])) & end_operation) | write_prot_true) | (do_write & (~ pagewr_buf_not_empty[8]))) | (((((~ do_write) & (~ do_sec_erase)) & (~ do_bulk_erase)) & (~ do_4baddr)) & end_operation)) | do_read_sid) | do_sec_prot) | do_read) | do_fast_read);
	// synopsys translate_off
	initial
		clr_write_reg2 = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( negedge clkin_wire)
		  cnt_bfend_reg <= cnt_bfend_wire_in;
	// synopsys translate_off
	initial
		do_wrmemadd_reg = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clkin_wire)
		  end_op_reg <= (((((((((((wire_stage_cntr_q[1] & (~ wire_stage_cntr_q[0])) & ((((((~ do_read) & (~ do_fast_read)) & (~ (do_write & shift_pgwr_data))) & end_one_cycle) | (do_read & end_read)) | (do_fast_read & end_fast_read))) | ((((wire_stage_cntr_q[1] & wire_stage_cntr_q[0]) & do_read_stat) & end_one_cycle) & (~ do_polling))) | ((((((do_read_rdid & end_one_cycle) & wire_stage_cntr_q[1]) & wire_stage_cntr_q[0]) & wire_addbyte_cntr_q[2]) & wire_addbyte_cntr_q[1]) & wire_addbyte_cntr_q[0])) | (((start_poll & do_read_stat) & do_polling) & (~ st_busy_wire))) | ((((~ wire_stage_cntr_q[1]) & wire_stage_cntr_q[0]) & (do_wren | (do_4baddr | (do_bulk_erase & (~ do_read_stat))))) & end_one_cycle)) | (((do_write | do_sec_erase) | do_bulk_erase) & write_prot_true)) | ((do_write & shift_pgwr_data) & end_pgwr_data)) | (do_write & (~ pagewr_buf_not_empty[8]))) | (((((wire_stage_cntr_q[1] & wire_stage_cntr_q[0]) & do_sec_prot) & (~ do_wren)) & (~ do_read_stat)) & end_one_cycle)) | ((((((wire_stage_cntr_q[1] & wire_stage_cntr_q[0]) & do_sec_erase) & (~ do_wren)) & (~ do_read_stat)) & end_add_cycle) & end_one_cycle));
	// synopsys translate_off
	initial
		end_opfdly_reg = 0;
	// synopsys translate_on
	...
	always @ ( posedge clkin_wire or  posedge clr_write_wire)
		...
		else if  (wire_write_prot_reg_ena == 1'b1)   write_prot_reg <= (((do_write | do_sec_erase) & ((((((((((((((addr_reg[23] & addr_reg[22]) & addr_reg[21]) & addr_reg[20]) & addr_reg[19]) & addr_reg[18]) & (~ bp2_wire)) & (~ bp1_wire)) & bp0_wire) | (((((((addr_reg[23] & addr_reg[22]) & addr_reg[21]) & addr_reg[20]) & addr_reg[19]) & (~ bp2_wire)) & bp1_wire) & (~ bp0_wire))) | ((((((addr_reg[23] & addr_reg[22]) & addr_reg[21]) & addr_reg[20]) & (~ bp2_wire)) & bp1_wire) & bp0_wire)) | (((((addr_reg[23] & addr_reg[22]) & addr_reg[21]) & bp2_wire) & (~ bp1_wire)) & (~ bp0_wire))) | ((((addr_reg[23] & addr_reg[22]) & bp2_wire) & (~ bp1_wire)) & bp0_wire)) | (((addr_reg[23] & bp2_wire) & bp1_wire) & (~ bp0_wire))) | ((bp2_wire & bp1_wire) & bp0_wire))) | be_write_prot);
	assign
	...
	always @ ( posedge clkin_wire or  posedge clr_write_wire)
		...
		else  write_rstat_reg <= ((((do_write | do_sec_erase) | do_bulk_erase) | do_4baddr) & (((~ wire_wrstage_cntr_q[1]) & (~ wire_wrstage_cntr_q[0])) | (wire_wrstage_cntr_q[1] & (~ wire_wrstage_cntr_q[0]))));
	// synopsys translate_off
	initial
		wrstat_dreg[0:0] = 0;
	// synopsys translate_on
	...
	assign
		...
		be_write_prot = (do_bulk_erase & (((bp3_wire | bp2_wire) | bp1_wire) | bp0_wire)),
		...
		busy = busy_wire,
		busy_wire = (((((((((do_read_rdid | do_read_sid) | do_read) | do_fast_read) | do_write) | do_sec_prot) | do_read_stat) | do_sec_erase) | do_bulk_erase) | do_4baddr),
		clkin_wire = clkin,
...
endmodule //ASMI_altasmi_parallel_efc2
//VALID FILE
...
module ASMI (
	...
	wire [7:0] sub_wire3;
	wire  sub_wire4;
	wire  illegal_write = sub_wire0;
	wire  data_valid = sub_wire1;
	wire  illegal_erase = sub_wire2;
	wire [7:0] dataout = sub_wire3[7:0];
	wire  busy = sub_wire4;

	ASMI_altasmi_parallel_efc2	ASMI_altasmi_parallel_efc2_component (
				.read (read),
	 ...
	 clearbox_defparam = "data_width=STANDARD;epcs_type=EPCS128;intended_device_family=Cyclone IV E;lpm_hint=UNUSED;lpm_type=altasmi_parallel;page_size=256;port_bulk_erase=PORT_USED;port_en4b_addr=PORT_UNUSED;port_fast_read=PORT_UNUSED;port_illegal_erase=PORT_USED;port_illegal_write=PORT_USED;port_rdid_out=PORT_UNUSED;port_read_address=PORT_UNUSED;port_read_rdid=PORT_UNUSED;port_read_sid=PORT_UNUSED;port_read_status=PORT_UNUSED;port_sector_erase=PORT_USED;port_sector_protect=PORT_USED;port_shift_bytes=PORT_USED;port_wren=PORT_USED;port_write=PORT_USED;use_eab=ON;" */;
