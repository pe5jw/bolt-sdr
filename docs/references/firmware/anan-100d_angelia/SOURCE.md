# ANAN-100D / Angelia — upstream source mirror

- **Radios covered:** ANAN-100D, Angelia
- **Protocol:** P1+P2
- **Upstream:** https://github.com/TAPR/OpenHPSDR-Firmware — Protocol 1/ANAN-100D, Protocol 2/Angelia (ANAN-100D)
- **Snapshot:** 2026-06-27
- **License:** GPL-3.0
- **Mirror size:** 4.1M (410 files), source-only
