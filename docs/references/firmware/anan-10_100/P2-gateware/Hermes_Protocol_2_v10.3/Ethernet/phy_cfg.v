...
assign values[6] = {8'h60, 8'hFF};  //rx and tx clock delay, in 0.12 ns units to reg 104h  // was F0/c0 E ok D stops C OK 
assign values[5] = 16'h8105;
assign values[4] = 16'h0000;			// no Rx pad skews, reg 105h		
assign values[3] = 16'h8106;
assign values[2] = 16'hFFFF;			// no Tx pad skews, reg 106h, added 25th Sept
