...
//  Modified for 100T operation only - copyright 2016, VK6PH
...
//                              clocks
//-----------------------------------------------------------------------------
wire   clock_12_5_mhz_0_deg, clock_25_mhz_180_deg;
assign clock_12_5MHz = clock_12_5_mhz_0_deg;     

assign  clock = clock_12_5_mhz_0_deg;
assign  PHY_TX_CLOCK = clock_25_mhz_180_deg;
  
//generate all tx clocks with a pll  
tx_pll	tx_pll_inst (
	.inclk0 (PHY_CLK125),
	.c0 (),
	.c1 (),
	.c2 (clock_12_5_mhz_0_deg),
	.c3 (clock_25_mhz_180_deg),
	.c4 (clock_2_5MHz)
	);   
   
//select clock for data sources in fpga   
//tx_clk_ctrl	tx_clk_ctrl_1 (
//	.clkselect ( speed_1Gbit ),
//	.inclk0x (clock_12_5_mhz_0_deg),
//	.inclk1x (clock_125_mhz_0_deg),
//	.outclk (clock)
//	);
//
////select tx clock for phy
//tx_clk_ctrl	tx_clk_ctrl_2 (
//	.clkselect (speed_1Gbit),
//	.inclk0x (clock_25_mhz_180_deg),
//	.inclk1x (clock_125_mhz_90_deg),
//	.outclk (PHY_TX_CLOCK)
//	);
