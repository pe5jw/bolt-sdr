# ANAN-8000DLE front-panel LCD MCU — upstream source mirror

- **Radios covered:** ANAN-8000DLE LCD controller
- **Protocol:** n/a
- **Upstream:** https://github.com/TAPR/OpenHPSDR-8000DLE_LCD_Firmware
- **Snapshot:** 2026-06-27
- **License:** no LICENSE declared (treat as GPL/TAPR)
- **Mirror size:** 176K (7 files), source-only
