# Andromeda (7000DLE/OrionMkII) front-panel MCU — upstream source mirror

- **Radios covered:** ANAN-7000DLE/8000DLE/OrionMkII front panel
- **Protocol:** n/a
- **Upstream:** https://github.com/laurencebarker/Andromeda_front_panel
- **Snapshot:** 2026-06-27
- **License:** see upstream repo
- **Mirror size:** 1.3M (84 files), source-only
