...
# Set False Path
#**************************************************************
set_false_path -to [get_ports {OSC_10MHZ}]
set_false_path -to [get_keepers {Merc_ID* SCL SDA CC C19 C21 C24 OVERFLOW}]
...
set_min_delay -from C122_clk -to spc[1] -1
set_min_delay -from C122_clk -to C22 -1
