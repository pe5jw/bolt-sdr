...
create_clock -period 122.880MHz	-name LTC2208_122MHz_3  [get_ports LTC2208_122MHz_3]
create_clock -period 122.880MHz	-name _122MHz		[get_ports _122MHz]
create_clock -period 100.000MHz	-name EXT_OSC_10MHZ 	[get_ports {EXT_OSC_10MHZ}]
...
set_clock_groups -asynchronous -group {PHY_CLK125 \
				...
				-group {EXT_OSC_10MHZ  PLL3_inst|altpll_component|auto_generated|pll1|clk[0]}\
...
set_input_delay -clock LTC2208_122MHz_3 1.000  { INA_3[*]}
...
# 15 degree phase shifted clock to DACD data, 122.88MHz
set_output_delay 1.00 -clock _122MHz { DACD[*] }
...
set_max_delay -from CDOUT -to cdc_sync:cdc_CDOUT|q1[0] 23

set_max_delay -from LTC2208_122MHz -to LTC2208_122MHz 13
set_max_delay -from LTC2208_122MHz -to _122MHz 10

set_max_delay -from PLL_clocks_inst|altpll_component|auto_generated|pll1|clk[1] -to PHY_CLK125 6
...
set_max_delay -from PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3] -to LTC2208_122MHz 9
