...
# for rev3
set ADCCLOCK		PLL_30MHz_inst|altpll_component|auto_generated|pll1|clk[1]	
...
set_max_delay -from _122MHz -to PLL_30MHz_inst|altpll_component|auto_generated|pll1|clk[0] 8
...
set_max_delay -from PLL_30MHz_inst|altpll_component|auto_generated|pll1|clk[0] -to SHIFT_inst|altpll_component|auto_generated|pll1|clk[0] 10
