...
# 
# modified 13 March 2022 for the Orion=>Angelia port, Joe Martin K5SO
...
create_generated_clock -name Orion_ADC:ADC_SPI|SCLK -source $CBCLK -divide_by 4 [get_ports Orion_ADC:ADC_SPI|SCLK]
...
# for rev5
set_output_delay  10 -clock $CBCLK { ADCMOSI nADCCS ADCCLK}
