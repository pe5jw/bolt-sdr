...
module Reconfigure (reset, clock, clk_freq, BootAddress, control, epcs, CRC_error, done);
...
24:	begin
	  if (Reason[0])  begin         // If we are here due to CRC Error, skip reconfig &
