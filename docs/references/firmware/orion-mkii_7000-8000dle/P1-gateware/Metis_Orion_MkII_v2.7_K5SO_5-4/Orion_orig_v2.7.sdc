...
set_max_delay -from PLL_clocks_inst|altpll_component|auto_generated|pll1|clk[1] -to PHY_CLK125 8
...
set_max_delay -from virt_CBCLK -to PLL_IF_inst|altpll_component|auto_generated|pll1|clk[0] 24
