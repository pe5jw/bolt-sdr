...
module Tx_MAC (Tx_clock, Tx_clock_2, IF_rst, Send_ARP,ping_reply,
			   ...
			   erase_done, erase_done_ACK, send_more, send_more_ACK, Orion_version,
...
input  [7:0]Orion_version;		// Orion code version
...
METIS_DISCOVERY:
	begin
		...
		else if (zero_count < 50)begin				// send 50 x 0x01s *** tidy code, Orion ID for PC code.
			Tx_data <= 8'd10;
