# Penelope / PennyLane (exciter brick) — upstream source mirror

- **Radios covered:** Penelope, PennyLane
- **Protocol:** P1+P2
- **Upstream:** https://github.com/TAPR/OpenHPSDR-Firmware — Protocol 1/Penelope, Protocol 2/Atlas/Penelope
- **Snapshot:** 2026-06-27
- **License:** GPL-3.0
- **Mirror size:** 2.2M (250 files), source-only
