...
//
// 19.1 Build 259 01/25/2012 SP 2 SJ Web Edition
// ************************************************************
...
`endif
	...
	assign
		...
		bit_counter_param_start_match = ((((((~ w51w[0]) & (~ w51w[1])) & (~ w51w[2])) & (~ w51w[3])) & (~ w51w[4])) & (~ w51w[5])),
		busy = (~ idle),
		...
		w4w = read_source,
		w51w = (wire_cntr5_q ^ bit_counter_param_start),
		w81w = (wire_cntr6_q ^ width_counter_param_width),
		...
		width_counter_param_width_match = (((((~ w81w[0]) & (~ w81w[1])) & (~ w81w[2])) & (~ w81w[3])) & (~ w81w[4])),
...
module Remote (
	...
	Remote_rmtupdt_51n	Remote_rmtupdt_51n_component (
				.clock (clock),
				.data_in (data_in),
