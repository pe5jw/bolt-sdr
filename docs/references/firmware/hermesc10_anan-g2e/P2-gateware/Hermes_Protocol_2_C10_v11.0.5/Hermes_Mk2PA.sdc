...
# CMCLK (12.288MHz) CBCLK(3.072MHz) CLRCLK (48KHz) _122_90 (122.88MHz)
...
set_input_delay 10  -clock  $clock_12_5MHz { ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cyclone_asmiblock2~ALTERA_DATA0}
...
set_output_delay  10 -clock $clock_12_5MHz {ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cyclone_asmiblock2~ALTERA_SCE ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cyclone_asmiblock2~ALTERA_SDO ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cyclone_asmiblock2~ALTERA_DCLK}
...
set_max_delay -from network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 24
...
set_max_delay -from userADC_clk -to network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 11
set_max_delay -from network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to userADC_clk 1
set_max_delay -from PLL_IF_inst|altpll_component|auto_generated|pll1|clk[2] -to _122MHz 9
...
set_min_delay -from network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to userADC_clk -2
...
set_false_path -from [get_clocks {network_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {tx_clock}]
...
set_false_path -to { Status_LED DEBUG_LED* DITH* IO1 FPGA_PTT  NCONFIG  RAND*  USEROUT* FPGA_PLL DAC_ALC DRV_BIAS }

#don't need fast paths from the following inputs
set_false_path -from  {ANT_TUNE IO4 IO5 IO6 IO8 KEY_DASH KEY_DOT OVERFLOW* PTT}
