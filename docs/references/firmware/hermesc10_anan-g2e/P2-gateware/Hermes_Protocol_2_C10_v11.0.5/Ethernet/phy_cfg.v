  ...
  if (!phychip[1])  begin
    ...
    if (ready) begin
      ...
      if (rd_data[9:4] == 6'b100001) begin // 9021
        ...
        values[7] <= 16'h8104;
        values[6] <= 16'h66a9; // RGMII Clock and Control Pad Skew
        values[5] <= 16'h8105;
        values[4] <= 16'h6666; // RGMII RX Data Pad Skew
        values[3] <= 16'h8106;
        values[2] <= 16'h9999; // RGMII TX Data Pad Skew
        ...
        values[16] <= 16'h0004;
        values[15] <= 16'h4002;
        values[14] <= 16'h0089; // RGMII Control Signal Pad Skew
        values[13] <= 16'h0002;
        values[12] <= 16'h0005;
        values[11] <= 16'h4002;
        values[10] <= 16'haaaa; // RGMII RX Data Pad Skew
        values[9] <= 16'h0002;
        values[8] <= 16'h0006;
        values[7] <= 16'h4002;
        ...
        values[4] <= 16'h0008;
        values[3] <= 16'h4002;
        values[2] <= 16'b0000_00_10101_10001; // RGMII Clock Pad Skew TX 5bits RX 5bits
        values[1] <= 16'h1300; // Restart autonegotiation
        values[0] <= 16'hxxxx;
        addresses[18] <= 9;
        addresses[17] <= 5'h0d;
