...
localparam Metis_serialno = 8'd30;	// Serial number of this version
...
// CW clocks,  profile clock = 192kHz, iambic_clk = 30kHz
wire pro_clock, iambic_clk;	
PLL_2 PLL_2_inst(.inclk0(C125_clk), .c0(pro_clock),  .c1(iambic_clk));
...
wire [15:0]level;
multiply multiply_inst ({IF_Drive_Level,IF_Drive_Level}, CW_RF, level); // 16 x 16 multiply with 16 bit result
