...
#******************************************************************************************
#
set_output_delay -add_delay -clock PHY_CLK125 -max 1.500 {ATLAS_A21 ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_DCLK ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_SCE ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_SDO ATLAS_A20 ATLAS_C2 ATLAS_C19 ATLAS_C20 ATLAS_C21 ATLAS_C24 HEART_BEAT NCONFIG NODE_ADDR_CS PHY_MDC PHY_MDIO PHY_TX[*] PHY_TX_CLOCK PHY_TX_EN RAM_A0 RAM_A1 RAM_A2 RAM_A3 RAM_A4 RAM_A5 RAM_A6 RAM_A7 RAM_A10 RAM_A11 RAM_A12 RAM_A13 SCK SI USEROUT0 USEROUT1 USEROUT2 USEROUT3}
set_output_delay -add_delay -clock PHY_CLK125 -min -0.500 {ATLAS_A21 ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_DCLK ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_SCE ASMI_interface:ASMI_int_inst|ASMI:ASMI_inst|ASMI_altasmi_parallel_cv82:ASMI_altasmi_parallel_cv82_component|cycloneii_asmiblock2~ALTERA_SDO ATLAS_A20 ATLAS_C2 ATLAS_C19 ATLAS_C20 ATLAS_C21 ATLAS_C24 HEART_BEAT NCONFIG NODE_ADDR_CS PHY_MDC PHY_MDIO PHY_TX[*] PHY_TX_CLOCK PHY_TX_EN RAM_A0 RAM_A1 RAM_A2 RAM_A3 RAM_A4 RAM_A5 RAM_A6 RAM_A7 RAM_A10 RAM_A11 RAM_A12 RAM_A13 SCK SI USEROUT0 USEROUT1 USEROUT2 USEROUT3}
...
set_max_delay -from PHY_CLK125 -to PLL_2_inst|altpll_component|auto_generated|pll1|clk[1] 8
...
set_max_delay -from PHY_RX_CLOCK_2 -to PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] 10
...
set_max_delay -from PLL_inst|altpll_component|auto_generated|pll1|clk[0] -to PLL_2_inst|altpll_component|auto_generated|pll1|clk[1] 116
set_max_delay -from PLL_inst|altpll_component|auto_generated|pll1|clk[0] -to PLL_inst|altpll_component|auto_generated|pll1|clk[0] 53
...
set_max_delay -from PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] -to PHY_CLK125 8
set_max_delay -from PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] -to sidetone2:sidetone_inst|sidetone_clock 5

set_max_delay -from PLL_2_inst|altpll_component|auto_generated|pll1|clk[1] -to PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] 4

set_max_delay -from sidetone2:sidetone_inst|sidetone_clock -to PLL_inst|altpll_component|auto_generated|pll1|clk[0] 12
...
set_min_delay -from PHY_CLK125 -to PLL_2_inst|altpll_component|auto_generated|pll1|clk[1] -2
...
set_min_delay -from PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] -to PHY_CLK125 -3
set_min_delay -from PLL_2_inst|altpll_component|auto_generated|pll1|clk[0] -to sidetone2:sidetone_inst|sidetone_clock -3

set_min_delay -from sidetone2:sidetone_inst|sidetone_clock -to PLL_inst|altpll_component|auto_generated|pll1|clk[0] -7
