  ...
  case (state)
		IDLE: 
			begin
				...
				if (discovery) begin
					response_tx_bits <= {32'd0, (8'd02 + {7'b0,run}), local_mac, board_type, protocol_version, code_version, merc1_ver, merc2_ver, merc3_ver, merc4_ver, penny_ver, metis_ver, number_Rx, 8'd1, 8'd0, beta_version}; 	// sequence number set to zero for future use
...
`ifdef DONT
						// skip some data in attempt to realign with I&Q from fifo
						// I MSB has a 1 in Rx_data[8]
