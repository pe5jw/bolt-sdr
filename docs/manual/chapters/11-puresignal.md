...
PureSignal is available on Protocol-2 boards (ANAN-G2, G2 MkII, Orion-class) and on the Hermes-Lite 2 over Protocol-1. A few details differ by board, and those are called out below.
