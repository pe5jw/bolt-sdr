...
function Get-EvidenceGateRecords {
    ...
    $manualTuneObserverRequireNr5CaptureReady = Test-Truthy (Get-JsonValue $Validation "manualTuneObserverRequireNr5CaptureReady")
    ...
    $manualTuneObserverNr5CaptureReadyPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverNr5CaptureReadyPollCount")
    $manualTuneObserverNr5CaptureBlockedPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverNr5CaptureBlockedPollCount")
    $manualTuneObserverNr5CaptureAdvisoryPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverNr5CaptureAdvisoryPollCount")
...
function Build-MarkdownReport {
    ...
    if (Test-Truthy (Get-JsonValue $Report "manualTuneObserverReportPresent")) {
        ...
        $lines.Add("- NR5 capture gate required/base-qualified/ready/blocked/advisory polls: $(Get-JsonValue $Report "manualTuneObserverRequireNr5CaptureReady") / $(Get-JsonValue $Report "manualTuneObserverBaseCaptureQualifiedPollCount") / $(Get-JsonValue $Report "manualTuneObserverNr5CaptureReadyPollCount") / $(Get-JsonValue $Report "manualTuneObserverNr5CaptureBlockedPollCount") / $(Get-JsonValue $Report "manualTuneObserverNr5CaptureAdvisoryPollCount")") | Out-Null
