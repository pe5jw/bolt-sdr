...
- Resolve required evidence gates before acceptance review: Strict bundle validation, G2 hardware evidence, WDSP native symbol audit, Offline fixture metric comparison, Live trace comparison.

## Evidence Gates

| Gate | Ready | Status | Required | Detail | Action |
|---|---:|---|---:|---|---|
| Strict bundle validation | False | failed | True | errors=6; warnings=1 | Resolve validation errors before using this bundle as DSP modernization evidence. |
...
| Offline fixture metric comparison | False | not-ready | True | present=False; sourceEngine=wdsp; comparisonEngine=; wdspBacked=False; sourceHash=not-evaluated; runtimeHash=not-evaluated; runtimeArtifactHash=match; scope=; skippedNonFixture=0; regressions=0; gateFailures=0; missingScenarios=0; missingCurrent=0; missingThetis=0; missingCandidates=0; missingValues=0 | Run run-dsp-wdsp-fixture-matrix.ps1 and resolve fixture, runtime, or metric regressions before acceptance review. |
...
## Fixture Metric Coverage

- Source evidence engine: wdsp
- Comparison evidence engine: 
- WDSP-backed evidence: False
- Source metrics path: artifacts/offline-fixture-metrics.json
- Comparison metrics path: 
- Source metrics SHA-256: e0d76feacda779c0452fdd4ea0a4b5f6500d13d2e7daaacc7e12d9936b476489
- Comparison metrics SHA-256: 
- Source hash status: not-evaluated
- Source WDSP runtime RID: win-x64
- Source WDSP runtime SHA-256: d684676acdb803fa9912c64fe707317eadbf03a0ccde2f068119378507465ede
- Comparison WDSP runtime SHA-256: 
- Runtime hash status: not-evaluated
- Runtime artifact hash status: match
- Packaged Win x64 WDSP SHA-256: d684676acdb803fa9912c64fe707317eadbf03a0ccde2f068119378507465ede
- Scenario scope: 
- Skipped non-fixture scenarios: 0
- Missing scenarios: 0
- Missing current-Zeus baselines: 0
- Missing Thetis-parity baselines: 0
- Missing candidate scenario coverage: 0
- Missing required metric values: 0
...
|---|---:|---|---:|---|---|---|
| Validation triage clean | False | validation-needs-attention | True | requiredGateProblems=5; referencedFileProblems=0; liveHistoryProvenanceNeedsAttention=False | Resolve the triage status and rerun validation before treating the bundle as acceptance evidence. | validation-report, g2-hardware, wdsp-native-symbol-audit, fixture-metric-comparison, live-trace-comparison |
| G2 first-pass evidence | False | blocked-prerequisites | True | hardware=diagnostics-missing; fixtureReady=False; liveTraceReady=False | Complete G2 hardware, WDSP audit, fixture, and live-trace gates before first-pass review. | validation-report, g2-hardware, wdsp-native-symbol-audit, fixture-metric-comparison, live-trace-comparison |
...
| Default DSP behavior graduation | False | blocked-g2-prerequisites | True | defaultBehaviorChangeReady=False; crossRadioValidationRequired=True; crossRadioValidationEvidenceStatus=not-captured; blockingGateCount=7 | Finish G2 first-pass evidence before planning cross-radio/default-graduation review. | validation-report, g2-hardware, wdsp-native-symbol-audit, external-engine-candidates, fixture-metric-comparison, live-trace-comparison, live-history-provenance |

## Acceptance Action Plan

- Action count: 7
- Required action count: 5
...
| 50 | run-offline-fixture-comparison | opt-in-candidate-comparison | fixture-metric-comparison | True | benchmark-fixture | 1 | powershell -NoProfile -ExecutionPolicy Bypass -File tools\run-dsp-wdsp-fixture-matrix.ps1 -BundleDir "$bundleDir" -Force | Resolve weak-signal, pumping, clipping, latency, or artifact regressions before live review; deterministic fixture evidence is only a schema fallback, not default-graduation proof. |
