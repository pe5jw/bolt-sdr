...
| NR5 weak-input dropout samples | 0 | 2 | lower | tie |
| NR5 weak-input recovery percent | 100 | 0 | higher | tie |
| NR5 hot makeup samples | 0 | 0 | lower | tie |
| NR5 low-evidence lifted samples | 73 | 0 | lower | improvement |
| NR5 output movement dB | 4.9 | 40.1 | lower | tie |
...
| Audio RMS movement dB | 0.4 | 4.2 | lower | tie |
| Maximum audio peak dBFS | -3.6 | -62.4 | lower | improvement |
| RX audio leveler output RMS movement dB | 0.4 | 4.2 | lower | tie |
