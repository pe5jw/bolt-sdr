...
|---|---:|---:|---|---:|
| Maximum audio peak dBFS | -7 | -2.6 | lower | -4.4 |
| RX audio leveler applied gain movement dB | 3.2 | 5.6 | lower | -2.4 |
| RX audio leveler peak-limited samples | 0 | 1 | lower | -1 |
...
| Maximum audio peak dBFS | -7 | -2.6 | lower | regression |
| RX audio leveler output RMS movement dB | 7.7 | 1.1 | lower | improvement |
| RX audio leveler applied gain movement dB | 3.2 | 5.6 | lower | regression |
| RX audio leveler boost-slew limited samples | 1 | 0 | lower | improvement |
| RX audio leveler peak-limited samples | 0 | 1 | lower | regression |
