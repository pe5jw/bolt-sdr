...
# 2. parseAudioFrame unused maken via comment
tsx = tsx.replace("function parseAudioFrame(", "// @ts-ignore" + chr(10) + "function parseAudioFrame(")
# 3. Audio verwerking vervangen
