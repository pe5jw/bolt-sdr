...
export default function App() {
  const { status, radioState, meters, display, send } = useRadioSocket()
      ...
      <main className="bolt-main">
        ...
        <section className="bolt-pan">
          <Panadapter
            ...
            onTune={hz => send({ type: 'set_vfo', hz })}
          />
        </section>
        ...
        <section className="bolt-controls">
          <VfoDisplay
            ...
            onChange={hz => send({ type: 'set_vfo', hz })}
          />
          <ModeFilter
            mode={radioState.mode}
            filterLow={radioState.filterLow}
            filterHigh={radioState.filterHigh}
            onMode={mode => send({ type: 'set_mode', mode })}
